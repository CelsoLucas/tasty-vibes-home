...
const Login = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Lógica de login será implementada quando conectar com banco de dados
    console.log("Login attempt:", { email, password });
  };

  const handleSocialLogin = (provider: string) => {
    // Lógica de login social será implementada quando conectar com banco de dados
      ...
      <div className="w-full max-w-md">
        <div className="bg-card rounded-2xl shadow-lg p-8 space-y-6">
          ...
          <div className="text-center space-y-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">Recomendo</h1>
