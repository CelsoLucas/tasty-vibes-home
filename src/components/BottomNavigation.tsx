  ...
  return (
    <nav className="fixed bottom-4 left-4 right-4 z-50 flex justify-center">
      <div className="relative bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg border border-white/20 dark:border-gray-700/20 rounded-3xl px-8 py-4 shadow-lg shadow-gray-900/10">
        {/* Bubble indicator */}
        <div 
          className="absolute top-3 w-10 h-10 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full transition-transform duration-500 ease-out-back shadow-lg shadow-orange-500/25"
          style={{
            transform: `translateX(${activeIndex * 68 + 4}px)`,
          }}
        />
